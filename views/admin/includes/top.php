	...
	<div class="wrapper">
		...
		<div
			...
			<img class="animation__shake"
				...
				alt="CONBRID" height="20%" width="20%">
		</div>
				...
				<li class="nav-item dropdown"><a class="nav-link"
					...
					<div class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
						<a href="#" class="dropdown-item">
							...
							<div class="media">
								<img
									src="<?php echo base_url("assets/admin")?>/dist/img/user1-128x128.jpg"
						...
						<a href="#" class="dropdown-item">
							...
							<div class="media">
								<img
									src="<?php echo base_url("assets/admin")?>/dist/img/user8-128x128.jpg"
						...
						<a href="#" class="dropdown-item">
							...
							<div class="media">
								<img
									src="<?php echo base_url("assets/admin")?>/dist/img/user3-128x128.jpg"
									alt="User Avatar" class="img-size-50 img-circle mr-3">
								<div class="media-body">
									<h3 class="dropdown-item-title">
