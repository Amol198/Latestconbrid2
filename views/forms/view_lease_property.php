...
<section id="team-sev" class="padding bg_light"
	...
	<h1 style="text-align: center;">Lease Property Form</h1>

	<form enctype='multipart/form-data'
			method="POST"  onsubmit="return validateForm()"
		action="<?php echo base_url("property/Property/accept_lease_property")?>">
		<div style="margin: 50px;">
			<div class="row">
			 <div class="col-md-4 form-group">
        <label>Type of Lease Property<sup>*</sup></label>
...
<div class="col-md-2 form-group">
          <label>Lease Amount(Rs)<sup>*</sup></label>
           <input  class="form-control" name="lease_amount1" type="number">
             Negotiable
           <input type="checkbox" name="lease_amount_negotiable1" value="1"  />
           </div>
   ...
   <div class="col-md-2 form-group" >
        <label>Lease Period (Year)<sup>*</sup></label>
        <select  id="lease_year1" name="lease_year1" class="form-control">
        <option value="">Please Select</option>
      ...
      <div class="col-md-2 form-group">
        <label>Lease Period (Month)<sup>*</sup></label>
        <select  id="lease_month1" name="lease_month1" class="form-control">
            <option value="">Please Select</option>
 ...
 <div class="row">
      <div class="col-md-2 form-group" >
        <label>Lock in Period (Year)</label>
        <select  id="lock_in_year1" name="lock_in_year1" class="form-control">
            <option value="">Please Select</option>
            <option value="1">1 year</option>
            <option value="2">2 years</option>
            <option value="3">3 years</option>
      ...
      <div class="col-md-2 form-group">
        <label>Lock in Period (Month)</label>
        <select  id="lock_in_month1" name="lock_in_month1" class="form-control">
            <option value="">Please Select</option>
            <option value="0">0 month</option>
            <option value="1">1 month</option>
            <option value="2">2 months</option>
      ...
      <div class="col-md-3 form-group">
					<label>Upload original E-Stamp lease agreement<sup>*</sup></label>
...
<div class="col-md-2 form-group">
          <label>Lease Amount(Rs)<sup>*</sup></label>
           <input  class="form-control" name="lease_amount2" type="number">
             Negotiable
           <input type="checkbox" name="lease_amount_negotiable2" value="1"  />
           </div>
   ...
   <div class="col-md-2 form-group" >
        <label>Lease Period (Year)<sup>*</sup></label>
        <select  id="lease_year2" name="lease_year2" class="form-control">
        <option value="">Please Select</option>
            <option value="1">1 year</option>
            <option value="2">2 years</option>
            <option value="3">3 years</option>
      ...
      <div class="col-md-2 form-group">
        <label>Lease Period (Month)<sup>*</sup></label>
        <select  id="lease_month2" name="lease_month2" class="form-control">
            <option value="">Please Select</option>
            <option value="0">0 month</option>
            <option value="1">1 month</option>
            <option value="2">2 months</option>
 ...
 <div class="row">
      <div class="col-md-2 form-group" >
        <label>Lock in Period (Year)</label>
        <select  id="lock_in_year2" name="lock_in_year2" class="form-control">
            <option value="">Please Select</option>
            <option value="1">1 year</option>
            <option value="2">2 years</option>
            <option value="3">3 years</option>
      ...
      <div class="col-md-2 form-group">
        <label>Lock in Period (Month)</label>
        <select  id="lock_in_month2" name="lock_in_month2" class="form-control">
            <option value="">Please Select</option>
            <option value="0">0 month</option>
            <option value="1">1 month</option>
            <option value="2">2 months</option>
...
<div class="col-md-2 form-group">
          <label>Lease Amount(Rs)<sup>*</sup></label>
           <input  class="form-control" name="lease_amount3" type="number">
             Negotiable
           <input type="checkbox" name="lease_amount_negotiable3" value="1"  />
           </div>
   ...
   <div class="col-md-2 form-group" >
        <label>Lease Period (Year)<sup>*</sup></label>
        <select  id="lease_year3" name="lease_year3" class="form-control">
        <option value="">Please Select</option>
            <option value="1">1 year</option>
            <option value="2">2 years</option>
            <option value="3">3 years</option>
      ...
      <div class="col-md-2 form-group">
        <label>Lease Period (Month)<sup>*</sup></label>
        <select  id="lease_month3" name="lease_month3" class="form-control">
            <option value="">Please Select</option>
            <option value="0">0 month</option>
            <option value="1">1 month</option>
            <option value="2">2 months</option>
 ...
 <div class="row">
      <div class="col-md-2 form-group" >
        <label>Lock in Period (Year)</label>
        <select  id="lock_in_year3" name="lock_in_year3" class="form-control">
            <option value="">Please Select</option>
            <option value="1">1 year</option>
            <option value="2">2 years</option>
            <option value="3">3 years</option>
      ...
      <div class="col-md-2 form-group">
        <label>Lock in Period (Month)</label>
        <select  id="lock_in_month3" name="lock_in_month3" class="form-control">
            <option value="">Please Select</option>
            <option value="0">0 month</option>
            <option value="1">1 month</option>
            <option value="2">2 months</option>
...
<div class="col-md-2 form-group">
          <label>Lease Amount(Rs)<sup>*</sup></label>
           <input  class="form-control" name="lease_amount4" type="number">
             Negotiable
           <input type="checkbox" name="lease_amount_negotiable4" value="1"  />
           </div>
   ...
   <div class="col-md-2 form-group" >
        <label>Lease Period (Year)<sup>*</sup></label>
        <select  id="lease_year4" name="lease_year4" class="form-control">
        <option value="">Please Select</option>
            <option value="1">1 year</option>
            <option value="2">2 years</option>
            <option value="3">3 years</option>
      ...
      <div class="col-md-2 form-group">
        <label>Lease Period (Month)<sup>*</sup></label>
        <select  id="lease_month4" name="lease_month4" class="form-control">
            <option value="">Please Select</option>
            <option value="0">0 month</option>
            <option value="1">1 month</option>
            <option value="2">2 months</option>
 ...
 <div class="row">
      <div class="col-md-2 form-group" >
        <label>Lock in Period (Year)</label>
        <select  id="lock_in_year4" name="lock_in_year4" class="form-control">
            <option value="">Please Select</option>
            <option value="1">1 year</option>
            <option value="2">2 years</option>
            <option value="3">3 years</option>
      ...
      <div class="col-md-2 form-group">
        <label>Lock in Period (Month)</label>
        <select  id="lock_in_month4" name="lock_in_month4" class="form-control">
            <option value="">Please Select</option>
            <option value="0">0 month</option>
            <option value="1">1 month</option>
            <option value="2">2 months</option>
...
function  validateForm(){
    switch($("select[name=main_type_of_property]").val()){
     ...
     else if ($("input[name=lease_amount1]").val()==""){
            alert("please enter lease amount");
            return false;
     }
     ...
     else if ($("select[name=lease_year1]").val()==""){
            alert("please select kease period year");
            return false;
     }
     else if ($("select[name=lease_month1]").val()==""){
            alert("please select lease period month ");
            return false;
     }
       
     else if ($("input[name=e_stamp1]").val()==""){
            alert("please upload E-stamp lease agreement scanned copy ");
            return false;
     }
     ...
     else if ($("input[name=lease_amount2]").val()==""){
            alert("please enter lease amount");
            return false;
     }
     ...
     else if ($("select[name=lease_year2]").val()==""){
            alert("please select lease period year");
            return false;
     }
     else if ($("select[name=lease_month2]").val()==""){
            alert("please select lease period month ");
            return false;
     }
     ...
     else if ($("input[name=lease_amount3]").val()==""){
            alert("please enter lease amount");
            return false;
     }
     ...
     else if ($("select[name=lease_year3]").val()==""){
            alert("please select kease period year");
            return false;
     }
     else if ($("select[name=lease_month3]").val()==""){
            alert("please select lease period month ");
            return false;
     }
     ...
     else if ($("input[name=lease_amount4]").val()==""){
            alert("please enter lease amount");
            return false;
     }
     ...
     else if ($("select[name=lease_year4]").val()==""){
            alert("please select lease period year");
            return false;
     }
     else if ($("select[name=lease_month4]").val()==""){
            alert("please select lease period month ");
            return false;
     }
