...
elseif(!isset($status) || (isset($status) && $status=="0")){
...
<div class="row"><div class="col-md-3"><input type="hidden" name="day_id[]" value="1">Monday</div><div class="col-md-2"><input name="starttime[]" class="datetime" type="time"></div><div class="col-md-2"><input name="endtime[]" class="form-control datetime" type="time"></div><div class="col-md-2"><input type="checkbox" value="1" name="weeklyoff[]" class="checkbox1"></div></div>
