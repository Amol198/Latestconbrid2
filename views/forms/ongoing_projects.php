...
<section id="team-sev" class="padding bg_light"
	...
	<form enctype='multipart/form-data' method="POST"
		action="<?php echo base_url("index.php/Company_images/accept_ongoing_images")?><?php if(isset($id)) echo "/".$id?>">
...
<div  style="margin:50px;">
    ...
    <label style="font-size:12px;">Mention the features of this ongoing project for customers to know</label>
<?php } else{?>
    <label style="font-size:12px;">Mention your scope of work completed in this ongoing project</label>
<?php }?>
    </div>
  ...
  <h1 style="text-align:center;">List of Ongoing Projects</h1>
  <table class="table" >
      <thead><tr>
          <th>Project Name</th>
          <th>Description</th>
          ...
          <?php foreach($ongoing_projects as $row){?>
          <tr><td>
              <?php echo $row['project_name'];?>
          </td><td><?php echo $row['project_description'];?></td>
          <td><img style="width:150px;" src="<?php echo base_url("images/company_images/ongoing_projects/".$row['image1'])?>"/></td>
          <td><img style="width:150px;" src="<?php echo base_url("images/company_images/ongoing_projects/".$row['image2'])?>"/></td>
          <td><img style="width:150px;" src="<?php echo base_url("images/company_images/ongoing_projects/".$row['image3'])?>"/></td>
          <td><img style="width:150px;" src="<?php echo base_url("images/company_images/ongoing_projects/".$row['image4'])?>"/></td>
          <td><a class="btn btn-info" href="<?php echo base_url("index.php/Company_images/ongoing_images/".$row['id'])?>">Edit</td>
          </tr>
          <?php }?>
          </tbody>
